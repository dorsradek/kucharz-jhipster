...
/**
 * Performance test for the Przepis entity.
 */
class PrzepisGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Przepis entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created przepis")
                .get("${new_przepis_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created przepis")
            .delete("${new_przepis_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
